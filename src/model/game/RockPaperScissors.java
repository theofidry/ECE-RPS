...
public class RockPaperScissors {
    ...
    public Result play() {
        ...
        if (getFirstPlayer().getScore() >= 6) {
            ...
            System.out.print(getFirstPlayer().getName() + "(score: " + getFirstPlayer().getScore() + ") has won against " + getSecondPlayer().getName() + "(score: " + getSecondPlayer().getScore() + ")\n");
            return Result.WIN;
        } else if (getFirstPlayer().getScore() == 5) {
            System.out.print(getFirstPlayer().getName() + "(score: " + getFirstPlayer().getScore() + ") has score a tie against " + getSecondPlayer().getName() + "(score: " + getSecondPlayer().getScore() + ")\n");
            return Result.TIE;
        } else {
            System.out.print(getFirstPlayer().getName() + "(score: " + getFirstPlayer().getScore() + ") has lost against " + getSecondPlayer().getName() + "(score: " + getSecondPlayer().getScore() + ")\n");
            return Result.LOST;
        }
    }
